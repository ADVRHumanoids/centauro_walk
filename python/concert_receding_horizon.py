...
class CartesioSolver:
    ...
    def __init__(self, urdf, srdf, pb, ti, ee_name, mpc_task) -> None:
...
def ci_interface(urdf, srdf, ti, ee_name, mpc_task):
    ...
    ci = CartesioSolver(urdf, srdf, pb, ti, ee_name, mpc_task)
...
ee_name = 'ee_E'
mpc_task = ti.getTask('ee_xyz')
ci = ci_interface(urdf, srdf, ti, ee_name, mpc_task)
...
while not rospy.is_shutdown():
    ...
    ci.set_model_from_solution(solver=ti.solver_rti)
